...
describe("ResourceSchema", () => {
  ...
  it("fails when website is not a valid URL and not empty string", () => {
    const resourceWithInvalidWebsite = {
      name: "Capital Metro",
      website: "not-a-url",
    };

    const result = ResourceSchema.safeParse(resourceWithInvalidWebsite);
  ...
  it("parses when all conditions met", () => {
